...
while (i < len(Inputs_OPV)):
    ...
    Fruit_Weight_OPV[i] = Fruit_Weight_Mat_OPV(Temp_OPV, Num_Plants)
...
print("The total amount of mature fruit weight for the OPV section in grams is = ", Total_Fruit_Weight_OPV[len(Inputs_OPV)-1])
print("The total amount of dry fruit weight for the OPV section in grams is = ", Total_Dry_Weight_OPV[len(Inputs_OPV)-1])

plt.figure(3)
plt.plot(Week, Fruit_Weight_OPV, label = 'Weekly OPV Fruit Weight (g)')
...
plt.figure(5)
plt.plot(Week, Total_Fruit_Weight_OPV, label = 'Total OPV Fruit Weight (g)')
...
while (i < len(Inputs_NonOPV)):
    ...
    Fruit_Weight[i] = Fruit_Weight_Mat_OPV(Temp, Num_Plants)
...
print("The total amount of mature fruit weight for the Non-OPV section in grams is = ", Total_Fruit_Weight[len(Inputs_NonOPV)-1])
...
plt.figure(5)
plt.plot(Week, Total_Fruit_Weight_OPV, label = 'Total Fruit Weight (g)')
